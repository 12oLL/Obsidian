...
var ja = {
  ...
  errors: {
    ...
    attachFormatOriginalnameMixed: "${originalname} \u306F\u5358\u72EC\u3067\u4F7F\u7528\u3059\u308B\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002\u4ED6\u306E\u30C6\u30AD\u30B9\u30C8\u3084\u5909\u6570\u3068\u7D44\u307F\u5408\u308F\u305B\u308B\u3053\u3068\u306F\u3067\u304D\u307E\u305B\u3093\u3002",
...
var Metadata = class {
   ...
   */
  async getAttachFileName(setting, dateFormat, originalAttach, adapter) {
...
var CreateHandler = class {
  ...
  renameCreateFile(attach, attachPath, attachName, source) {
    ...
    this.app.vault.rename(attach, dst).then(() => {
      if (name !== attachName) {
        new import_obsidian11.Notice(t("notices.fileRenamed", { from: name, to: attachName }));
      }
